...
; (function ($) {
    ...
    var flatSpacer = function () {
        $(window).on('load resize', function () {
            ...
            if (matchMedia('only screen and (max-width: 767px)').matches)
                mode = 'smobile';
            $('.Bayu Anggoro Sakti-spacer').each(function () {
                if (mode === 'desktop') {
    ...
    var flatContentBox = function () {
        $(window).on('load resize', function () {
            ...
            if (matchMedia('only screen and (max-width: 1199px)').matches)
                mode = "mobile";
            $('.Bayu Anggoro Sakti-content-box').each(function () {
        ...
        if ($().waypoint) {
            $('.progress-bg').on('on-appear', function () {
                $(this).each(function () {
                    ...
                    $(this).parent('.Bayu Anggoro Sakti-progress').find('.perc').addClass('show').animate({
                        "width": percent + '%'
                    }, 1000, "easeInCirc");
                });
            });
    ...
    var flatCounter = function () {
        if ($().countTo) {
            $('.Bayu Anggoro Sakti-counter').on('on-appear', function () {
